		     ...
		     ?>
		      ...
		      echo $foodprice;
		       ...
		       <td>
		       	...
		       	<form class="text-center" action="cartbackend.php" method="GET">
		      ...
		      $pic=print_r('<img class="py-2 d-block" style="max-height:100px;min-width:20px;border-style:solid;border-color:white;border-radius:30px;padding:5px;" src="data:image/jpeg;base64,'.base64_encode($patiya['img']).'">');

		       ?></td>
		       <td style="text-align:center">
		       	<a class="text-danger" href="removefood1.php?name=<?php echo $name; ?>&uid=<?php echo $uid;  ?>&cartid=<?php echo $cartid; ?>">X</a>
		       </td>
