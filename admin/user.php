...
<header style="background-color: white;" class="shadow">
 ...
 -->
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                     ...
                     <div class="row">
                         <div class="col-sm-11">
                            <input type="search" name="search" placeholder="Search the Email Id" id="form1" class="form-control" />
  ...
  <tbody>
                                ...
                                <?php
                                $search= $_POST['search'];
                                $sanjay="SELECT * FROM `user` WHERE `email`='$search'";
                                ...
                                $putra=mysqli_fetch_array($gita);
                                    ...
                                    <tr>
                                      ...
                                      <td><?php print_r($putra['name']); ?></td>
                                      <td><?php print_r($putra['email']); ?></td>
                                      <td><?php print_r($putra['mobile']); ?></td>
                                      <td><?php print_r($putra['pass']); ?></td>
                                      <td><?php print_r($putra['dob']); ?></td>
                                      <td><?php print_r($putra['address']); ?></td>
                                      <td><?php print_r($putra['addedon']); ?></td>
                                                        ...
                                                        while($awi=mysqli_fetch_array($tai))
                                                        {
                                                            ...
                                                            ?>
                                                             ...
                                                             <tr>
                                                              ...
                                                              <td><?php print_r($awi['name']); ?></td>
                                                                <td><?php print_r($awi['email']); ?></td>
                                                             
                                                              <td><?php print_r($awi['mobile']); ?></td>
                                                              <td><?php print_r($awi['pass']); ?></td>
                                                              <td><?php print_r($awi['dob']); ?></td>
                                                              <td><?php print_r($awi['address']); ?></td>
                                                              <td><?php print_r($awi['addedon']); ?>
                                                             </td>
                                                            </tr>
