...
<header style="background-color: white;" class="shadow">
 ...
 ?>
                            <div class="container shadow">
                                <form style="padding: 30px; border-style: solid;border-color: black;padding: 10px;" action="goodgalleryback.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="container">
                             ...
                             ?>
                                              ...
                                              <td>
                                                  <form method="post" action="goodgalleryback.php">
