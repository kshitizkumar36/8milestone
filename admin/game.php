                            ...
                            if(isset($_POST['sear']))
                            {
                                ?>
                                                  ...
                                                  <tbody>
                                                     <?php 
                                                    include('../db.php');
                                                    $query="SELECT * FROM `sportboooking` ";
                                                    $tai=mysqli_query($connect,$query);
                                                    $awi=mysqli_fetch_array($tai);
                                                         ...
                                                         <tr>
                                                          ...
                                                          <td><?php
                                                           ...
                                                           echo $gar;
                                                            ...
                                                            ?></td>
                                                          <td><?php print_r($awi['sportid']); ?></td>
                                                          <td><?php print_r($awi['member']); ?></td>
                                                          <td><?php print_r($awi['people']); ?></td>
                                                          <td><?php print_r($awi['ondate']); ?></td>

                                                          <td><?php print_r($awi['refno']); ?></td>
                                                             <td>
                                          
                                          <form method="post" action="stop.php">
                                            <input type="hidden"value="<?php echo $sid; ?>" name="did">
                                              <input type="submit" class="btn btn-success" value="Mark Delivered" name="done">
                                          </form>
                                          <!--  -->
