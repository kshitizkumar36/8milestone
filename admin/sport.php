...
<header style="background-color: white;" class="shadow">
 ...
 ?>
                            <div class="container shadow">
                                <form style="padding: 30px; border-style: solid;border-color: black;padding: 10px;" action="addsport.php" method="post">
                                   
                                    
                                    <br>
                                    <input type="text"required="required" placeholder="Sport Name" class="form-control" name="game">
                                    <br>
                                    <hr>
                                    ...
                                    <br>
                                    <input type="submit" value="Add Sports" class="form-control btn btn-success" name="">
                                </form>
                            </div>
                                          ...
                                          <tbody>
                                            ...
                                            {   
                                              ...
                                              <th scope="row"><?php print_r($bird['id']);  ?></th>
                                                  <td><?php print_r($bird['game']);  ?></td>
                                              <td><?php print_r($bird['addedon']);  ?></td>
                                              <td>
                                                  <form method="post" action="delgame.php">
