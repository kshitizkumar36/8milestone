            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                       ...
                       <div class="container">
                           <div class="row">
                                <div style="   background-color: #e1e1e2 ; padding: 60px;border-style: solid;border-color: white;" class="col-sm-6 shadow">
                                    <h2><a style="color: #2a3042;text-decoration: none;" href="food.php">Add Food Category</a></h2>
                                </div>

                                   <div style="   background-color: #e1e1e2 ; padding: 60px;border-style: solid;border-color: white;" class="col-sm-6 shadow">
                                    <h2><a style="color: #2a3042;text-decoration: none;" href="foodsubcategory.php">Add Food Subcategory</a></h2>
                                </div>
