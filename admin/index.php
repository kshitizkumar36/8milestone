            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                       ...
                       <div class="container">
                           <div class="row">
                               <div style="padding:10px;height: px;background-color: #e1e1e2;border-style: solid;border-color: white;" class="col-sm-3 shadow">
                                    <a href="sport.php"><h2 style="padding: 60px;">Add Sports</h2></a>
                               </div>
                               <div style="padding:10px;height: px;background-color: #e1e1e2;border-style: solid;border-color: white;" class="col-sm-3 shadow">
                                    <a href="choosefood.php"><h2 style="padding: 60px;">Add Food</h2></a>
                               </div>
                               <div style="padding:10px;height: px;background-color: #e1e1e2;border-style: solid;border-color: white;" class="col-sm-3 shadow">
                                    <a href="sportgallery.php"><h2 style="padding: 60px;">Sports Gallery</h2></a>
                               </div>
                               <div style="padding:10px;height: px;background-color: #e1e1e2;border-style: solid;border-color: white;" class="col-sm-3 shadow">
                                    <a href="foodgallery.php"><h2 style="padding: 60px;">Food Gallery</h2></a>
                               </div>
                           </div>
