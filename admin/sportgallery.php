...
<header style="background-color: white;" class="shadow">
 ...
 ?>
                            <div class="container shadow">
                                <form style="padding: 30px; border-style: solid;border-color: black;padding: 10px;" action="sportgalleryback.php" method="post" enctype="multipart/form-data">
                                   
                                    
                                    <br>

                                    <br>
                                    <label>Upload Sport picture</label>
                                    ...
                                    <br>
                                    <input type="submit" value="Add Photo" class="form-control btn btn-success" name="food">
                                </form>
                            </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <table class="table">
                                          ...
                                          <tbody>
                                            ...
                                            <?php
                                            include('../db.php');
                                            $query= "SELECT * FROM `gallery` WHERE `title`='sport' ";
                                            $fly= mysqli_query($connect,$query);
                                            while($bird= mysqli_fetch_array($fly))
                                            {   
                                                ?>
                                                <tr>
                                              <th scope="row"><?php print_r($bird['id']);  ?></th>
                                                  <td><?php print_r($bird['title']);  ?></td>
                                              <td>
                                                       <?php
                             ...
                             ?>
                                              ...
                                              <td>
                                                  <form method="post" action="sportgalleryback.php">
