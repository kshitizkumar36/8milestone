...
<header style="background-color: white;" class="shadow">
 ...
 ?>
                            <div class="container shadow">
                                <form style="padding: 30px; border-style: solid;border-color: black;padding: 10px;" action="foodbackend.php" method="post" enctype="multipart/form-data">
                                   
                                    
                                    <br>

                                    <label>Add Food Category</label>


                                    <input type="text"required="required" placeholder="Food Name" class="form-control" name="foodname">
                                    <br>
                            ...
                            <div class="container">
                             ...
                             ?>
                                              ...
                                              <td>
                                                  <form method="post" action="foodbackend.php">
